						...
						<div class="container">
							<div class="row">
								<div class="extra-div col-lg-3 col-md-4 col-12">
									...
									<a href="<spring:url value='/sub_admin/profile'/>"><input
								...
								<div class="extra-div col-lg-3 col-md-4 col-12">
									...
									<a href="<spring:url value='/sub_admin/search_consumer'/>"><input
										type="button" value="Go" class="btn btn-outline-primary"></a>
								</div>
								<div class="extra-div col-lg-3 col-md-4 col-12" >
									...
									<a href="<spring:url value='/sub_admin/search'/>"><input
										type="button" value="Go" class="btn btn-outline-primary"></a>
								</div>
								<div class="extra-div col-lg-3 col-md-4 col-12">
									...
									<a href="<spring:url value='/sub_admin/search_payment_report'/>"><input
										type="button" value="Go" class="btn btn-outline-primary"></a>
								</div>
							</div>
