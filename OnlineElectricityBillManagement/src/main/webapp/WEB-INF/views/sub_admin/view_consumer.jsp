...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="<spring:url value='/sub_admin/search_consumer'/>"
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-fw fa-users"></i> <span style="font-size: 1.2em;">View
						Consumer</span>
			</a></li>
						...
						<div class="col-xl-8 mb-4">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									...
									<h5 class="m-0 font-weight-bold text-primary" align="center">Consumer
										Details</h5>
								</div>
