...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="<spring:url value='/admin/search_consumer'/>"
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-user"></i> <span style="font-size: 1.2em;">Add
						User</span>
			</a></li>
			<li class="nav-item"><a class="nav-link collapsed"
						...
						<div class="col-xl-8 mb-4">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									...
									<h5 class="m-0 font-weight-bold text-primary" align="center">Consumer Details</h5>
								</div>
								...
								<div class="card-body row">
										...
										<h5 class="col-md-8">${requestScope.consumer_details.id}</h5>
										<h5 class="col-md-4">
											<b>Consumer Name :</b>
										</h5>
										<h5 class="col-md-8">${requestScope.consumer_details.firstName}&nbsp;&nbsp;&nbsp;${requestScope.consumer_details.lastName}</h5>
										<h5 class="col-md-4">
											<b>Email :</b>
										</h5>
										<h5 class="col-md-8">${requestScope.consumer_details.email}</h5>
										<h5 class="col-md-4">
											<b>Mobile :</b>
										</h5>
										<h5 class="col-md-8">${requestScope.consumer_details.phone}</h5>
										<h5 class="col-md-4">
											<b>Address :</b>
										</h5>
										<h5 class="col-md-8">${requestScope.consumer_details.address}</h5>
										<h5 class="col-md-4">
											<b>Zone :</b>
										</h5>
										<h5 class="col-md-8">${requestScope.consumer_details.zone}</h5>
										<h5 class="col-md-4">
											<b>City :</b>
										</h5>
										<h5 class="col-md-8">${requestScope.consumer_details.city}</h5>
										<h5 class="col-md-4">
											<b>State :</b>
										</h5>
										<h5 class="col-md-8">${requestScope.consumer_details.state}</h5>
										<h5 class="col-md-10 text-center">
											<a href="<spring:url value='/admin/update?cid=${requestScope.consumer_details.id}'/>"><input
												type="button" value="Update" class="btn btn-outline-success"></a>
											<a href="<spring:url value='/admin/delete?cid=${requestScope.consumer_details.id}'/>"><input
												type="button" value="Delete" class="btn btn-outline-danger"></a>
										</h5>
								</div>
							</div>
						</div>
