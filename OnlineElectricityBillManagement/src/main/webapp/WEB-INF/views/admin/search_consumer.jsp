				...
				<div class="container-fluid">
					...
					<div class="col-lg-7">
						...
						<div class="text-center ">
							<h5 align="center"
								style="${requestScope.message eq 'Invalid Consumer Id ,Please retry' ? 'color:red' : 'color:green' }">${requestScope.message}</h5>
							<hr>
						</div>
						<form method="GET" action="<spring:url value='/admin/consumer'/>">
