...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Sidebar - Brand -->
			<li class="sidebar-brand d-flex align-items-center justify-content-center bg-white" > 
							...
							<div class="col-xl-8 mb-4">
								...
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h4 align="center" class="m-0 font-weight-bold text-info">Update
											Details</h4>
										...
										<form:form method="post" modelAttribute="user"
											...
											<div class="form-group">
												...
												<form:input path="address" type="text"
													class="form-control form-control-user"
													value="${requestScope.consumer.address}" />
											...
											<div class="form-group">
												...
												<form:input path="zone" type="text" readOnly="true"
													class="form-control form-control-user"
													value="${requestScope.consumer.zone}" />
												<form:errors path="zone" style="color: red;" />
											</div>
											<div class="form-group">
												<label> <i class="fas fa-globe"></i> City*
												</label>
												<form:input path="city" type="text" readOnly="true"
													class="form-control form-control-user"
													value="${requestScope.consumer.city}" />
												<form:errors path="city" style="color: red;" />
											</div>
											<div class="form-group">
												<label> <i class="fas fa-building"></i> State*
												</label>
												<form:input path="state" type="text" readOnly="true"
													class="form-control form-control-user"
													value="${requestScope.consumer.state}" />
											...
											<div class="form-group row">
												<div class="col-sm-12 mb-3 mb-sm-0">
													...
													<form:input path="password" type="password" readOnly="true"
														class="form-control form-control-user"
														value="${requestScope.consumer.password}" />
